...
console.log("========================\n");
console.log(
	"This demo shows the difference between regular and human-like typing.\n",
);
...
async function runDemo() {
	...
	try {
		...
		console.log(
			`   Time difference: +${humanDuration - regularDuration}ms (due to variations and corrections)\n`,
		);
